(function($) {
	...
	jQuery(window).bind("load", function() {
		//wait until page load to let the loginbtn work
		jQuery("#LoginBtn").css("pointer-events", "inherit");
		...
		switch(site) {
            ...
            case "dev.makerfaire.com":
				...
				if(jQuery("body").hasClass("page-template-page-makerfaire-map")) {
					nextItemUnderNav = jQuery("#directory");
				} else {
					nextItemUnderNav = jQuery(".clear");
				}
				break;
			case "makerspaces":
			...
			case "experiences.devmakehub.wpengine.com":
                ...
                break;
			case "makercamp":
			case "makercamp.wpengine.com":
			case "makercamp.staging.wpengine.com":
         	case "makercamp.com":
         	case "stage.makercamp.com":
         	case "dev.makercamp.com":
				universalNavActive("camp");
				if(jQuery(".tribe-events-view--happening-now")[0]) {
					nextItemUnderNav = jQuery(".tribe-events-view--happening-now");
				}else {
					nextItemUnderNav = jQuery(".main-content");
				}
				break;
