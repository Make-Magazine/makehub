...
if (empty($_GET['subtab'])){
	...
	<div class="iump-page-title">Ultimate Membership Pro -
		<span class="second-text">
			<?php esc_html_e('Stripe Connect', 'ihc');?>
		</span>
	</div>
					...
					<div class="inside">
						...
						<?php }else{?>
								<div class="ihc-alert-warning"><?php echo esc_html__('Switch to ', 'ihc'); ?> <a href="<?php echo $url.'&tab='.$tab.'&subtab=stripe_connect';?>"><strong>Stripe Connect</strong></a> <?php echo esc_html__('Payment Service to have access on all Stripe functionalities and complete Subscriptions management. Follow ', 'ihc');?>
									...
									<?php echo esc_html__(' steps to accomplish this few minutes.', 'ihc'); ?></div>
						<?php }?>
                  ...
                  <div class="col-xs-6">
					...
					<div class="iump-form-line">
						...
						<ul class="ihc-payment-capabilities-list">
							...
							<li><?php esc_html_e('After that click on "Developers" -> "Overview" and check the current "API version". Be sure that the latest (2020-08-27) is chosen and set as Default.', 'ihc');?></li>
							<li><?php esc_html_e('Then select "API Keys" and check "Publishable Key" and "Secret Key". If have been created with an old API version, you have to delete and re-create them. If does not exist yet create them.', 'ihc');?></li>
							<li><?php esc_html_e('Go to "Webhooks" and press "Add endpoint".', 'ihc');?></li>
							<li><?php echo esc_html__("Set your Endpoint URL to: ", 'ihc') . '<strong>' . $notify_url . '</strong>';?> <?php esc_html_e(' and choose all the events from "Charge", "Customer", "Invoice", "Subscription Schedule".', 'ihc');?><?php esc_html_e(' Be sure that latest API version is used for webhooks.', 'ihc');?></li>
						...
						<div class="ihc-stuffbox">
							...
							<input type="hidden" value="<?php echo $meta_arr['ihc_braintree_sandbox'];?>" name="ihc_braintree_sandbox" id="ihc_braintree_sandbox" />
								...
								<div class="iump-form-line">
									...
									<ul class="ihc-payment-capabilities-list">
										<li><?php echo esc_html__("Go to ", 'ihc');?><a href="https://www.braintreepayments.com" target="_blank">https://www.braintreepayments.com</a> <?php echo esc_html__("(or ", 'ihc');?> <a href="https://www.braintreepayments.com/en-ro/sandbox" target="_blank">https://www.braintreepayments.com/en-ro/sandbox</a> <?php echo esc_html__("if you want to use sandbox version) and login with username and password.", 'ihc');?></li>
							...
							<div class="ihc-stripe-connect-test-wrapper">
								<div class="iump-form-line">
		                         <h2><?php esc_html_e('Test Credentials (only on Test Mode)', 'ihc');?></h2>
		                            ...
		                            <p><?php esc_html_e('Example:', 'ihc');?></p>
		                            <p><?php esc_html_e('Credit Card: ', 'ihc');?>4000002500003155</p>
		                            <p><?php esc_html_e('Expire Time: ', 'ihc');?>1224</p>
		            </div>
							</div>
