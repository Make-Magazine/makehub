...
<form action="" method="post">
	<div class="ihc-stuffbox">
		...
		<div class="inside">
			...
			<div class="iump-form-line">
					...
					<p style="max-width:800px;"><?php _e('Link a WooCommerce product with a membership from "Product Edit Page". Once an order with that product is created into Woo, a new UMP order is created and the subscription is managed based on that order status.', 'ihc');?></p>
				...
				<p style=" font-size:110%; font-weight:bold;"><?php _e('The user will have an active membership only when the WooCommerce order will be set as completed (manually or automatically).', 'ihc');?></p>
			</div>
    ...
    line-height: 1.4;">
						<tr>
							<td style="font-weight:400;padding: 16px 12px;"><?php _e('Ultimate Membership Pro Membership', 'ihc');?></td>
							<td style="font-weight:400;padding: 16px 12px;"><?php _e('WooCommerce Product', 'ihc');?></td>
						</tr>
					</thead>
