			...
			<form method="post">
				<div class="ihc-stuffbox">
					...
					<div class="inside">
						...
						<div class="input-group"><span class="input-group-addon"><?php esc_html_e('Additional Main E-Mail', 'ihc');?></span><input type="text" name="ihc_main_email" value="<?php echo $meta_arr['ihc_main_email'];?>" class="form-control" /></div>
						</div>
						</div>
						</div>
