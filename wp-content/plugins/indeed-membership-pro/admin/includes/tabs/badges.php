...
<form action="" method="post">
	<div class="ihc-stuffbox">
		<h3 class="ihc-h3"><?php _e('Membership Membership Badges', 'ihc');?></h3>
		<div class="inside">

			<div class="iump-form-line">
				<h2><?php _e('Activate/Hold Memberhsip Badges', 'ihc');?></h2>
				<p><?php _e('Add a custom badge for each membership for a better approach. Be sure that you add images with a proper size and ratio and for each membership.', 'ihc');?></p>
