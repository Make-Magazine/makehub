(function($) {
  $(document).ready(function() {
    // console.lo
    //Email edit togglers
    $('a.mpgft-edit-email-toggle').click(function(e) {
    ...
    $('a.mpgft-insert-email-var').click( function(e) {
      e.preventDefault();
    ...
    function mpgft_send_test_email(obj_name, dashed_obj_name, subject, body, use_template) {
      var data = {
        action: 'mpgft_send_test_email',
        e: obj_name,
        s: subject,
        b: body,
        t: use_template,
    ...
    $('a.mpgft-send-test-email').click(function(e) {
      e.preventDefault();
      ...
      mpgft_send_test_email(obj_name, dashed_obj_name, subject, body, use_template);
    });

    function mpgft_set_email_defaults(obj_name,dashed_obj_name,subject_id,body_id,use_template_id) {
      var data = {
        action: 'mpgft_set_email_defaults',
        e: obj_name,
    ...
    $('a.mpgft-reset-email').click(function(e) {
      e.preventDefault();
      ...
      mpgft_set_email_defaults(body_obj,dashed_obj_name,subject_id,body_id);
    });
  });
})(jQuery);
