...
Shadow allows you to display your video content full screen with a captivating user experience.
...
1. Upload `vimeography-shadow.zip` to the `/wp-content/plugins/` directory
...
= 2.0 =
* This is the first public release of the Shadow theme.
