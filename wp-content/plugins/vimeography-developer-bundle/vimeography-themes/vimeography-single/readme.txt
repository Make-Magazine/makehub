...
Single retrieves the single latest video from the provided Vimeo source.
...
1. Upload `vimeography-single.zip` to the `/wp-content/plugins/` directory
...
= 2.0 =
* Rewrote the Single theme for Vimeography 2.0 compatibility.
