...
// URLSearchParams polyfill for Microsoft Edge 16 support
...
const render = (Component, galleryId, store) => {
  ...
  const gallery = window.vimeography2.galleries.bridge[galleryId];
...
for (let id in window.vimeography2.galleries.bridge) {
