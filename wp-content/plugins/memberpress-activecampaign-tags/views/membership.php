<div id="mepr-activecampaign-tags" class="mepr-product-adv-item">
  ...
  <label for="mepractivecampaign_add_tags"><?php _e('Active Campaign tags for this Membership', 'memberpress-activecampaigntags'); ?></label>
  ...
  <?php MeprAppHelper::info_tooltip('mepractivecampaign-add-tags',
    ...
    __('If this is set and tags are added to this Membership then anyone who is active will have these tags applied. If the user becomes inactive on this membership then they will be removed from their contact record. Note: Changing the tag values here after some are applied to contact records in Active Campaign, will prevent them from being removed later from those records if they become inactive.', 'memberpress-activecampaigntags'));
  ?>
