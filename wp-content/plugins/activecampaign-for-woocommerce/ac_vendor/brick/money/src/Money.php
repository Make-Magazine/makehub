...
use AcVendor\Brick\Money\Context\DefaultContext;
use AcVendor\Brick\Money\Exception\MoneyMismatchException;
use AcVendor\Brick\Money\Exception\UnknownCurrencyException;

use AcVendor\Brick\Math\BigDecimal;
use AcVendor\Brick\Math\BigInteger;
use AcVendor\Brick\Math\BigNumber;
use AcVendor\Brick\Math\BigRational;
use AcVendor\Brick\Math\RoundingMode;
use AcVendor\Brick\Math\Exception\MathException;
use AcVendor\Brick\Math\Exception\NumberFormatException;
use AcVendor\Brick\Math\Exception\RoundingNecessaryException;
...
final class Money extends AbstractMoney
{
     ...
     * The amount.
     *
     * @var \AcVendor\Brick\Math\BigDecimal
     */
    private $amount;
     ...
     * The currency.
     *
     * @var \AcVendor\Brick\Money\Currency
     */
    private $currency;
