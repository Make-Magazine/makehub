...
use Automattic\WooCommerce\Admin\Composer as Admin_Package;
...
<div id="activecampaign-for-woocommerce-app" data='{
	...
	"custom_email_field": "<?php echo esc_html( sanitize_text_field( $activecampaign_for_woocommerce_custom_email_field ) ); ?>",
	"loading": false
}'>

	<ac-notice v-for="notice in notices" :level="notice.level" :message="notice.message"
			   :key="notice.message"></ac-notice>
	...
	<b-tabs type="is-boxed" v-model="activeTab">
		...
		<form method="POST" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>"
			...
			<b-tab-item id="activecampaign_connection"
				...
				<ac-input name="api_url"
						  label="<?php esc_html_e( 'API URL', ACTIVECAMPAIGN_FOR_WOOCOMMERCE_LOCALIZATION_DOMAIN ); ?>"
						  v-model="api_url"></ac-input>
				<ac-input name="api_key"
			...
			<b-tab-item id="activecampaign_store"
						label="<?php esc_html_e( 'Store Settings', ACTIVECAMPAIGN_FOR_WOOCOMMERCE_LOCALIZATION_DOMAIN ); ?>">
				...
				<ac-radio v-for='(label, value) in abCartOptions' :key='value' :label='label' :value='value'
						  name='abcart_wait' :selected='abcart_wait'></ac-radio>
				...
				<ac-input name="optin_checkbox_text"
						  label="<?php esc_html_e( 'Checkbox text', ACTIVECAMPAIGN_FOR_WOOCOMMERCE_LOCALIZATION_DOMAIN ); ?>"
						  v-model="optin_checkbox_text"></ac-input>
				...
				<ac-radio v-for='(label, value) in checkboxDisplayOptions' :key='value' :label='label' :value='value'
						  name='checkbox_display_option' :selected='checkbox_display_option'></ac-radio>

			</b-tab-item>

			<b-tab-item id="activecampaign_status"
						label="<?php esc_html_e( 'Status', ACTIVECAMPAIGN_FOR_WOOCOMMERCE_LOCALIZATION_DOMAIN ); ?>">
				<div id="activecampaign_status_copy_button">
					<span id="copyStatus"></span>
					<ac-button id="copyButton">Copy to clipboard</ac-button>
				</div>
			...
			<b-tab-item id="activecampaign_advanced"
						label="<?php esc_html_e( 'Advanced', ACTIVECAMPAIGN_FOR_WOOCOMMERCE_LOCALIZATION_DOMAIN ); ?>">
				<h2>
