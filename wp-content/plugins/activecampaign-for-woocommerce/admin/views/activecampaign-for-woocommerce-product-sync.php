...
<div id="activecampaign-for-woocommerce-product-sync" class="wrap">
	<div class="notice notice-info inline">
		...
		<p>
			Sync your product data to power the campaign product block like never before. Please reach out to ActiveCampaign support if you have any issues
		</p>
	</div>
	<h1>
		<?php
				...
				<div id="sync-start-section">
					<div>
						<form method="post"
							...
							<button type="button" id="activecampaign-run-product-sync" class="button">
								<?php
								esc_html_e(
									'Schedule Product Sync Jobs',
									ACTIVECAMPAIGN_FOR_WOOCOMMERCE_LOCALIZATION_DOMAIN
								);
								?>
							</button>
							<button id="activecampaign-reset-product-sync" class="button" type="button">
								<?php
								esc_html_e(
									'Reset Sync Status',
									ACTIVECAMPAIGN_FOR_WOOCOMMERCE_LOCALIZATION_DOMAIN
