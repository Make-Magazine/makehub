...
class Elementor_myMspaces_Widget extends \Elementor\Widget_Base {
    ...
    if (!empty($ms_results)) {
        ...
        <div class="dashboard-box expando-box">
            <h4 class="open"><?php echo ($settings['title']!=''?$settings['title']:'My &nbsp;&nbsp;<img src="https://makerspaces.make.co/wp-content/universal-assets/v1/images/makerspaces-logo.jpg" />');?></h4>
            <ul class="open">
