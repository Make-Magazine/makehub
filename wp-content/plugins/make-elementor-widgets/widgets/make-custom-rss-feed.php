		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'11' => esc_html__( '11', 'elementor-make-widget' ),
					'12' => esc_html__( '12', 'elementor-make-widget' ),
					'13' => esc_html__( '13', 'elementor-make-widget' ),
					'14' => esc_html__( '14', 'elementor-make-widget' ),
					'15' => esc_html__( '15', 'elementor-make-widget' ),
					'16' => esc_html__( '16', 'elementor-make-widget' ),
					'17' => esc_html__( '17', 'elementor-make-widget' ),
					'18' => esc_html__( '18', 'elementor-make-widget' ),
					'19' => esc_html__( '19', 'elementor-make-widget' ),
					'20' => esc_html__( '20', 'elementor-make-widget' ),
					'21' => esc_html__( '21', 'elementor-make-widget' ),
					'22' => esc_html__( '22', 'elementor-make-widget' ),
					'23' => esc_html__( '23', 'elementor-make-widget' ),
					'24' => esc_html__( '24', 'elementor-make-widget' ),
					'25' => esc_html__( '25', 'elementor-make-widget' ),
					'26' => esc_html__( '26', 'elementor-make-widget' ),
					'27' => esc_html__( '27', 'elementor-make-widget' ),
					'28' => esc_html__( '28', 'elementor-make-widget' ),
					'29' => esc_html__( '29', 'elementor-make-widget' ),
					'30' => esc_html__( '30', 'elementor-make-widget' ),
				],
			]
		);
		$this->add_control(
