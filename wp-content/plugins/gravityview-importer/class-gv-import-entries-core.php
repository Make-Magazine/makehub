...
class Core {
	...
	public static function bootstrap() {
		...
		require_once $plugin_dir_path . 'class-gv-import-entries-wp-import-screen.php';

		require_once $plugin_dir_path . 'class-gv-import-entries-gf-toolbar-menu.php';
		...
		require_once $plugin_dir_path . 'class-gv-import-entries-batch.php';

		add_action( 'init', array( '\GV\Import_Entries\Batch', 'register_post_type' ) );

		require_once $plugin_dir_path . 'class-gv-import-entries-log.php';
		require_once $plugin_dir_path . 'class-gv-import-entries-processor.php';

		add_action( 'rest_api_init', array( __CLASS__, 'rest_api_init' ) );

		// Initialize UI
		require_once $plugin_dir_path . 'class-gv-import-entries-ui.php';
		$UI = new UI( self::version );
	}
	...
	public static function rest_api_init() {
		require_once plugin_dir_path( __FILE__ ) . 'class-gv-import-entries-rest-batch-controller.php';
		...
		register_rest_route( Core::rest_namespace, "/process", array(
			array(
				...
				'callback'            => array( '\GV\Import_Entries\Processor', 'rest_process' ),
	...
	public static function get_meta_fields() {
		...
		$known_objects = array(
			'\GravityView_Maps_Loader' => array(
				'lat'  => __( 'Latitude', 'gravityview-importer' ),
				'long' => __( 'Longitude', 'gravityview-importer' ),
			),
			'\GVCommon' => array(
				'is_approved' => __( 'Approval Status', 'gravityview-importer' ),
			),
		);
		 ...
		 * @param[in,out] array Key-value array of known meta fields
		 */
