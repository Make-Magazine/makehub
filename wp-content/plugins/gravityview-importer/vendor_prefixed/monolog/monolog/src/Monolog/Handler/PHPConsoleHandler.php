...
use Exception;
use GravityKit\GravityImport\Monolog\Formatter\LineFormatter;
 ...
 *
 *      $logger = new \GravityKit\GravityImport\Monolog\Logger('all', array(new \GravityKit\GravityImport\Monolog\Handler\PHPConsoleHandler()));
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    private $options = array(
        ...
        'classesPartialsTraceIgnore' => array('GravityKit\\GravityImport\\Monolog\\'), // array Hide calls of classes started with...
