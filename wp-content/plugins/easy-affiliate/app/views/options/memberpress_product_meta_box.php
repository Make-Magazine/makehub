...
<div class="wafp-memberpress-meta-box">
  ...
  <label for="wafp_enable_commission_group"><?php esc_html_e('Enable Commission Group', 'easy-affiliate'); ?></label>
  <?php
    AppHelper::info_tooltip(
      'esaf-product-enable-commission-group',
      sprintf(
        // translators: %1$s: br tag
        esc_html__('If enabled, purchasers of this product will be added to your Easy Affiliate affiliate program and will be enrolled in a special commission group set here.%1$s%1$sCommissions for these affiliates will be calculated based on this commission structure.', 'easy-affiliate'),
        '<br />'
      )
    );
  ?>
