...
use GF_GF_To_CPT;
/**
 * Gravity Forms GF to CPT Post Update Handler.
 *
...
class Post_Update_Handler {
	...
	public function update() {
		 ...
		 */
		do_action( 'gform_formsgftocpt_pre_update_post', $this->post, $this->feed, $this->entry );
		 ...
		 * @param array $entry The entry linked to the post.
		 */
		$this->post = apply_filters( 'gform_formsgftocpt_update_post_data', $this->post, $this->feed, $this->entry );
