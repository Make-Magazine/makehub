/* global jQuery, ajaxurl, gform_formstocpt_form_settings_strings */
					...
					$value.select2( {
						ajax: {
							...
							data: function( params ) {
								return {
									action: 'gform_formstocpt_taxonomy_search',
									nonce: gform_formstocpt_form_settings_strings.nonce_search,
