/* global jQuery, ajaxurl, gform_formsgftocpt_form_settings_strings */
					...
					$value.select2( {
						ajax: {
							...
							data: function( params ) {
								return {
									action: 'gform_formsgftocpt_taxonomy_search',
									nonce: gform_formsgftocpt_form_settings_strings.nonce_search,
