...
<?php if ( $show_content ) : ?>
	...
	<?php if ( ! empty( $quizzes ) ) : ?>
		<div id="learndash_quizzes">
			<div id="quiz_heading"><span><?php echo LearnDash_Custom_Label::get_label( 'quizzes' ); ?></span><span class="right"><?php _e( 'Status', 'lds_skins' ) ?></span></div>

			<div id="quiz_list" class="ldvc-enhanced-list">
