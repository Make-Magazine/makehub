	...
	extends \threewp_broadcast\premium_pack\base
{
	...
	**/
	public function threewp_broadcast_broadcasting_before_restore_current_blog( $action )
	{
		...
		if ( $pcp->taxonomies )
		{
			$this->debug( 'Taxonomies restored.' );
			$bcd->parent_post_taxonomies = $pcp->blogs->collection( $blog_id )->get( 'parent_post_taxonomies' );
		}
	...
	public function threewp_broadcast_broadcasting_after_switch_to_blog( $action )
	{
		...
		if ( $pcp->taxonomies )
		{
			$this->debug( 'Taxonomies saved.' );
			$pcp->blogs->collection( $blog_id )->set( 'parent_post_taxonomies', $bcd->parent_post_taxonomies );
