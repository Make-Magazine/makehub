 ...
 */
namespace GravityKit\GravityRevisions\Katzgrau\KLogger;
 ...
 *
 * Usage:
 * $log = new GravityKit\GravityRevisions\Katzgrau\KLogger\Logger('/var/log/', GravityKit\GravityRevisions\Psr\Log\LogLevel::INFO);
