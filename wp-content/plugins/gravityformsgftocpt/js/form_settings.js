( function( $ ) {
	...
	$( document ).ready( function() {
		...
		$( '#postAuthor' ).select2( {
		    allowClear:  false,
		    placeholder: gform_formsgftocpt_form_settings_strings.select_user,
			ajax:        {
				url:      ajaxurl,
				dataType: 'json',
				delay:    250,
				data:     function( params ) {
					return {
						action: 'gform_formsgftocpt_author_search',
						nonce:  gform_formsgftocpt_form_settings_strings.nonce_author,
						query:  params.term,
					}
				}
			}
