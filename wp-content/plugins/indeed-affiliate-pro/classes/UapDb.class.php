			...
			switch ($type){
				...
				case 'general-public_workflow':
					$arr = array(
							...
							'uap_payments_warnings_message' => "You didn't submit any Payout Method. You can complete setup ",
...
<div><strong>Refuse Referrals :</strong> {refuse_referrals}</div>
		...
		public function get_payment_types_available(){
			 ...
			 */
			 $payments = array(
								...
								'stripe_v3' => __('Stripe Managed Accounts ', 'uap'),
			 );
		...
		public function getLandingPagesForAffiliate($affiliateId=0)
    {
		...
		public function getCategoriesForServiceType( $type='' )
		{
			...
			{
					global $wpdb;
					return $wpdb->get_results( "SELECT ID, user_login FROM {$wpdb->users};");
			}
