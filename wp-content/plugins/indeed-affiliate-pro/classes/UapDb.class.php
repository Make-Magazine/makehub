	...
	class UapDb{
		...
		public function create_tables(){
			...
			if ($wpdb->get_var( $query ) != $table_name){
				...
				CHARACTER SET utf8 COLLATE utf8_general_ci;"; /// old version: end_date TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP
				dbDelta($sql);
			}
			...
			if ($wpdb->get_var( $query ) != $table_name){
				...
				CHARACTER SET utf8 COLLATE utf8_general_ci;"; /// old version : update_date TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
				dbDelta($sql);
			}
