...
class WooSpecificReferralRates
{
    ...
    public function addTab( $tabs=[] )
    {
        $tabs['uap_woo_wsr'] = array(
                      'label'  => __( 'Ultimate Affiliate Pro - Specific Referral Rate', 'uap' ),
                      'target' => 'uap_woo_wsr',
    ...
    public function tab()
    {
        ...
        $types = [
                          'flat' 					=> __( 'Flat ', 'uap') . '(' . $currency .')',
                          'percentage'		=> __( 'Percentage ', 'uap') . '(%)',
                          'default'       => __( 'Default Affiliate system Settings', 'uap' ),
        ];
        $data = [
