...
if (!class_exists('UapMainAdmin')){
	class UapMainAdmin{
		...
		public function add_style_scripts(){
			...
			wp_enqueue_style('uap_main_admin_style', UAP_URL . 'assets/css/main_admin.css', array(), 7.0);
			if ($is_plugin_page){
				...
				wp_enqueue_style('uap_main_public_style', UAP_URL . 'assets/css/main_public.min.css', array(), 7.0);
				wp_enqueue_style('uap_templates', UAP_URL . 'assets/css/templates.min.css', array(), 7.0);
			}
			...
			wp_enqueue_media();
			wp_register_script('uap_admin_js', UAP_URL . 'assets/js/admin-functions.min.js', array(), 7.0 );
