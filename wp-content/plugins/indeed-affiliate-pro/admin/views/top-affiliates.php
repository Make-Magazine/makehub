<?php
wp_enqueue_script( 'uap-public-functions', UAP_URL . 'assets/js/public-functions.js', array(), 1.3 );
$meta_arr = array(
							'num_of_entries' => 10,
							'entries_per_page' => 5,
							'order_by' => 'earnings',
							...
							wp_enqueue_script( 'uap-owl-carousel', UAP_URL . 'public/listing_users/assets/js/owl.carousel.js', [], 1.1 );
		                            ...
		                            <ul id="colors_ul" class="colors_ul">
		                                <?php
		                                    ...
		                                    foreach ($color_scheme as $color){
		                                        ...
		                                        ?>
		                                            <li class="<?php echo $class;?>  uap-box-background-<?php echo $color;?>" onClick="uapChangeColorScheme(this, '<?php echo $color;?>', '#color_scheme');uapPreviewUList();" ></li>
		                                        <?php
		                                        $i++;
		                                    }
		                                ?>
