<?php wp_enqueue_script('uap_admin_js', UAP_URL . 'assets/js/admin-functions.js', array(), 1.2 );?>
  ...
  <div><strong><?php esc_html_e('Set this Post for affiliate:', 'uap');?></strong></div>
    ...
    <div class="input-group">
        ...
        <div id="uap_username_search_tags"><?php
              ...
              ?>
              <div id="<?php echo $id;?>" class="uap-tag-item"><?php echo $data['affiliate_usename'];?><div class="uap-remove-tag" onclick="uapRemoveTag('<?php echo $data['uap_landing_page_affiliate_id'];?>', '#<?php echo $id;?>', '#usernames_search_hidden');" title="<?php esc_html_e('Removing tag', 'uap');?>">x</div></div>
              <?php
              }
        ?></div>
