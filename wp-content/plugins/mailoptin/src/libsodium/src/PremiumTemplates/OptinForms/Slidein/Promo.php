...
[mo-close-optin class="promo-optin-form-close"]x[/mo-close-optin]
...
HTML;
    ...
    public function optin_form_css()
    {
        ...
        $form_border_color = $this->get_customizer_value('form_dotted_border_color', '#2c303d');
...
html div#$optin_uuid div#$optin_css_id.promo-container .mo-mailchimp-interest-container .mo-mailchimp-interest-choice {
  ...
  html div#$optin_uuid div#$optin_css_id.promo-container .promo-optin-form-close {
    position: absolute;
    width: 35px;
    height: 35px;
    top: -18px;
