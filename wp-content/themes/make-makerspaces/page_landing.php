 ...
 *
 * This file adds the landing page template to the Make - Makerspaces Theme.
 *
 ...
 */
function make_learn_add_body_class( $classes ) {
...
add_action( 'wp_enqueue_scripts', 'make_learn_dequeue_skip_links' );
/**
 * Dequeues Skip Links Script.
 *
 * @since 1.0.0
 */
function make_learn_dequeue_skip_links() {
