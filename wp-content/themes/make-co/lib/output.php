 ...
 *
 * This file adds the required CSS to the front end to the Make - Community Theme.
 *
 * @package Make - Co
 * @author  Maker Media
...
add_action( 'wp_enqueue_scripts', 'make_co_css' );
/**
...
function make_co_css() {
	...
	if ( $logo ) {
		...
		$logo_max_width        = get_theme_mod( 'make_co_logo_width', 350 );
	...
	$css .= ( make_co_customizer_get_default_link_color() !== $color_link ) ? sprintf(
		'
	...
	$css .= ( make_co_customizer_get_default_accent_color() !== $color_accent ) ? sprintf(
		'
