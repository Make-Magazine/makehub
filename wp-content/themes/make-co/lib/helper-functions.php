 ...
 * Make - Co Theme
 *
 * This file adds the required helper functions used in the Make - Co Theme.
 *
 * @package Make - Co
 * @author  Maker Media
 ...
 */
function make_co_customizer_get_default_link_color() {
 ...
 */
function make_co_customizer_get_default_accent_color() {
 ...
 */
function make_co_color_contrast( $color ) {
 ...
 */
function make_co_color_brightness( $color, $change ) {
