...
* Tools: Improve `npm run zip` command to create archives that unzip to a 'make-co' folder on Windows.
...
* Tools: Add npm scripts for automation. See https://github.com/studiopress/make-co#npm-scripts.
...
[2.8.0]: https://github.com/copyblogger/make-co/compare/2.7.1...2.8.0
[2.7.1]: https://github.com/copyblogger/make-co/compare/2.7.0...2.7.1
[2.7.0]: https://github.com/copyblogger/make-co/compare/2.6.0...2.7.0
[2.6.0]: https://github.com/copyblogger/make-co/compare/2.3.0...2.6.0
[2.3.0]: https://github.com/copyblogger/make-co/compare/2.2.4...2.3.0
[2.2.4]: https://github.com/copyblogger/make-co/compare/2.2.3...2.2.4
[2.2.3]: https://github.com/copyblogger/make-co/compare/014deb3689323b7bbd4ddbfff4f5f9279a38f741...2.2.3
