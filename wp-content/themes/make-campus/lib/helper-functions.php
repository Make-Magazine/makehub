 ...
 * Make Campus Theme
 *
 * This file adds the required helper functions used in theMaker Campus Theme.
 *
 * @package Make - Campus
 ...
 */
function make_campus_customizer_get_default_link_color() {
 ...
 */
function make_campus_customizer_get_default_accent_color() {
 ...
 */
function make_campus_color_contrast( $color ) {
 ...
 */
function make_campus_color_brightness( $color, $change ) {
