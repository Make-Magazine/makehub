...
* Tools: Improve `npm run zip` command to create archives that unzip to a 'make-campus' folder on Windows.
...
* Tools: Add npm scripts for automation. See https://github.com/studiopress/make-campus#npm-scripts.
