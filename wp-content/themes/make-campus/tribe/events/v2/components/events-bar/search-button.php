...
<a class="tribe-events-c-events-bar__search-button" href="javascript:void(jQuery('.tribe-events-c-events-bar__search-filters-container').toggle())" style="font-size:20px;float:left">Search or Filter</a>