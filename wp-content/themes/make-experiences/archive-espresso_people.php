	...
	<main id="main" class="site-main">
		...
		<?php if ( have_posts() ) : ?>
			<header class="page-header">
				<h1 class="page-title">Maker Campus: Facilitators</h1>
				<?php
			...
			<div class="post-grid <?php echo esc_attr( $class ); ?>">
				...
				while ( have_posts() ) :
					 ...
					 */
					get_template_part( 'template-parts/content-espresso_events-people-list', apply_filters( 'bb_blog_content', get_post_format() ) );
