        ...
        <div class="widget bb-enroll-widget">
            ...
            <div class="bb-course-preview-content">
				...
				if ( apply_filters( 'learndash_login_modal', true, $course_id, $user_id ) && ! is_user_logged_in() ) {
					...
					echo '<a class="learndash-stripe-checkout-button btn-join button" href="/wp-login.php?redirect_to='.WP_SITEURL.$_SERVER['REQUEST_URI'].'">' . __( 'Login', 'buddyboss-theme' ) . '</a>';
				} else {
				?>
				...
				if ( false === $is_enrolled  ) {
					if ( $course_price_type == 'paynow' ) {
						...
						if ( '' === $course_price && $course_price_type == 'subscribe' ) {
							...
							echo wp_kses_post( '<span class="ld-currency text">' . learndash_30_get_currency_symbol() . '</span> ' );
