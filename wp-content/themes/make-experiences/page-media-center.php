...
<div id="media-center-page" class="page-content">
  ...
  <div class="container">
    ...
    <!--<p class="lead text-center">Here you’ll find our press releases and resources for your use.<br/>Please contact us if you need specific information.</p>-->
...
<script>
  ...
  jQuery('.nav-tabs-responsive').on('shown-accordion.bs.tabcollapse', function(){
