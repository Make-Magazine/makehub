...
class upcoming_mfaires_widget extends WP_Widget {
    ...
    function __construct() {
        parent::__construct(
                ...
                __('Upcoming Maker Faires Widget', 'upcoming_mfaires_widget_domain'),
                // Widget description
    ...
    public function widget($args, $instance) {
        ...
        echo("<a href='https://makerfaire.com/map' target='_blank'><img class='mf-logo' src='/wp-content/themes/makezine/images/makerfaire-logo.png' /></a>");
        if (!empty($title)) {
