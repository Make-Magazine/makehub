...
class fancy_rss_widget extends WP_Widget {
    ...
    public function update($new_instance, $old_instance) {
        ...
        if (isset($new_instance['show_summary'])) {
            $instance['show_summary'] = $new_instance['show_summary'] == 'on' ? 1 : 0;
        }
        if (isset($new_instance['show_author'])) {
            $instance['show_author'] = $new_instance['show_author'] == 'on' ? 1 : 0;
        }
        if (isset($new_instance['show_date'])) {
            $instance['show_date'] = $new_instance['show_date'] == 'on' ? 1 : 0;
        }
