                ...
                if (class_exists('EE_Registry')) :
                    ...
                    $events = EEM_Event::instance()->get_all(
                            array(
                                ...
                                array('Datetime.DTT_EVT_start' => array('>', current_time('mysql')), 'status' => 'publish')
                            )
                    );
                    ...
                    foreach ($events as $event) {                             
                        ...
                        if ((date('Y-m-d H:i:s', $firstExpiredDate) < $now && $ticket_count == 1) || $event->total_available_spaces() === 0) {
                            $return = '';
                        }else{
