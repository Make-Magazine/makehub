...
function dashboard_info_content() {
    ...
    if (!empty($hosted_events)) {
        $return .= '<div class="dashboard-box expando-box">
                        <h4 class="open"><img src="' . get_stylesheet_directory_uri() . '/images/makercampus-logo.jpg" /> Facilitator</h4>
                        <ul class="open">';
    ...
    if ($events) {
        $return .= '<div class="dashboard-box expando-box" style="width:100%">
                ...
                . '    <ul class="open">';
        $return .= '        <li>';
        $return .= '            <div class="espresso-my-events evetn_section_container">
