...
<script type="text/html" id="tmpl-activity-post-case-avatar">
	...
	<div class="activity-post-avatar-container">
		<a class="activity-post-avatar" href="/dashboard"><img src="{{{data.avatar_url}}}" class="avatar user-{{data.user_id}}-avatar avatar-{{data.avatar_width}} photo" width="{{data.avatar_width}}" height="{{data.avatar_width}}" alt="{{data.avatar_alt}}" /></a>
	</div>
	<# } #>
</script>
