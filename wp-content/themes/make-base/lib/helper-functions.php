 ...
 * Make - Base Theme
 *
 * This file adds the required helper functions used in the Make - Base Theme.
 *
 * @package Make - Base
 ...
 */
function make_base_customizer_get_default_link_color() {
 ...
 */
function make_base_customizer_get_default_accent_color() {
 ...
 */
function make_base_color_contrast( $color ) {
 ...
 */
function make_base_color_brightness( $color, $change ) {
