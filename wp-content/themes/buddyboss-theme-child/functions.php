...
function buddyboss_theme_child_scripts_styles()
{
  ...
  wp_enqueue_style('universal.css', content_url() . '/universal-assets/v1/css/universal.min.css', '', '1.0.2' );
  ...
  wp_enqueue_script('universal', content_url() . '/universal-assets/v1/js/min/universal.min.js', '', '1.0.2' );
