...
add_action( 'wp_enqueue_scripts', 'learn_custom_gutenberg_css' );
/**
 ...
 * @since 1.1.0
 */
function learn_custom_gutenberg_css() {

	$custom_color = get_theme_mod( 'learn_link_color', learn_customizer_get_default_link_color() );
	$accent_color = get_theme_mod( 'learn_accent_color', learn_customizer_get_default_accent_color() );
...
add_action( 'enqueue_block_editor_assets', 'learn_custom_gutenberg_admin_css' );
/**
 ...
 * @since 1.1.0
 */
function learn_custom_gutenberg_admin_css() {
...
CSS;
	...
	wp_add_inline_style( 'learn-gutenberg-fonts', $css );
